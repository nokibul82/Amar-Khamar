...
class InvestmentPaymentScreen extends StatefulWidget {
  final String? investmentType;
  const InvestmentPaymentScreen({super.key, this.investmentType = ""});

  @override
  State<InvestmentPaymentScreen> createState() =>
      _InvestmentPaymentScreenState();
}

class _InvestmentPaymentScreenState extends State<InvestmentPaymentScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<ProjectController>(builder: (projectCtrl) {
      return GetBuilder<PlanController>(builder: (planCtrl) {
        return GetBuilder<DepositController>(builder: (_) {
          return Container(
            ...
            child: Scaffold(
              ...
              appBar: CustomAppBar(
                title: storedLanguage['Investment'] ?? "Investment",
                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                child: AppCustomDropDown(
                                  ...
                                  onChanged: (value) async {
                                    ...
                                    if (_.is_crypto == false) {
                                      await _.getSelectedCurrencyData(value);
                                      await projectCtrl
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Text(
                                                  "Payment In ${_.is_crypto ? "USD" : _.selectedCurrency}",
                                                  style: context.t.displayMedium
                                                      ?.copyWith(
                                                          color: Get.isDarkMode
                                                              ? AppColors
                                              ...
                                              Expanded(
                                                ...
                                                child: Text(
                                                    "${Helpers.numberFormatWithAsFixed2("", projectCtrl.amountInSelectedCurr)} ${_.is_crypto ? "USD" : _.selectedCurrency}",
                                                    maxLines: 1,
                                                    overflow:
                                            ...
                                            children: [
                                              ...
                                              Expanded(
                                                ...
                                                alignment:
                                                    Alignment.centerRight,
                                                child: Text(
                                                    "${Helpers.numberFormatWithAsFixed2("", projectCtrl.charge)} ${_.is_crypto ? "USD" : _.selectedCurrency}",
                                                    maxLines: 1,
                                                    overflow:
                                                        TextOverflow.ellipsis,
                                                    style: context
                                            ...
                                            children: [
                                              ...
                                              Expanded(
                                                ...
                                                alignment:
                                                    Alignment.centerRight,
                                                child: Text(
                                                    "${Helpers.numberFormatWithAsFixed2("", projectCtrl.payableAmount)} ${_.is_crypto ? "USD" : _.selectedCurrency}",
                                                    maxLines: 1,
                                                    overflow:
                                                        TextOverflow.ellipsis,
                                                    style: context
                                            ...
                                            children: [
                                              ...
                                              Expanded(
                                                ...
                                                alignment:
                                                    Alignment.centerRight,
                                                child: Text(
                                                    "${projectCtrl.payableInBaseCurr}  ${HiveHelp.read(Keys.baseCurrency)}",
                                                    maxLines: 1,
                                                    overflow:
                                                        TextOverflow.ellipsis,
                                                    style: context
                              ...
                              Material(
                                color: Colors.transparent,
                                child: AppButton(
                                  isLoading: planCtrl.isPayment ||
                                          projectCtrl.isPayment ||
                                          _.isLoadingPaymentSheet
                                      ? true
                                      : false,
                                  onTap: planCtrl.isPayment ||
                                          projectCtrl.isPayment ||
                                          _.isLoadingPaymentSheet
                                      ? null
                                      : () async {
                                          ...
                                          // if investmentType is Plan
                                          if (widget.investmentType == "Plan") {
                                            await planCtrl.planInvest(
                                                context: context,
                                                fields: {
                                                  "balance_type":
                                                      planCtrl.balanceType,
                                                  "amount":
                                                      planCtrl.amountCtrl.text,
                                                  "plan_id": planCtrl.plannId,
                                                  if (planCtrl.balanceType ==
                                                          "checkout" &&
                                                      addFundCtrl.is_crypto ==
                                                          false)
                                                    "supported_currency":
                                                        _.selectedCurrency,
                                                  if (planCtrl.balanceType ==
                                                  ...
                                                  if (planCtrl.balanceType ==
                                                      "checkout")
                                                    "gateway_id": _.gatewayId,
                                                });
                                          }
                                          // if investmentType is Project
                                          else if (widget.investmentType ==
                                              "Project") {
                                            await projectCtrl.projectInvest(
                                                context: context,
                                                fields: {
                                                  "balance_type":
                                                      projectCtrl.balanceType,
                                                  "amount": projectCtrl
                                                      .amountCtrl.text,
                                                  "project_id":
                                                      projectCtrl.projectId,
                                                  "unit": projectCtrl.unit,
                                                  if (projectCtrl.balanceType ==
                                                          "checkout" &&
                                                      addFundCtrl.is_crypto ==
                                                          false)
                                                    "supported_currency":
