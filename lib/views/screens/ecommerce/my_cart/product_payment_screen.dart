                        ...
                        child: Column(
                          ...
                          children: [
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              ...
                                              child: Text(
                                                  "${Helpers.numberFormatWithAsFixed2("", productManageCtrl.amountInSelectedCurr)} ${_.is_crypto ? "USD" : _.selectedCurrency}",
                                                  maxLines: 1,
                                                  overflow:
                                                      TextOverflow.ellipsis,
                                                  style:
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              ...
                                              alignment: Alignment.centerRight,
                                              child: Text(
                                                  "${Helpers.numberFormatWithAsFixed2("", productManageCtrl.charge)} ${_.is_crypto ? "USD" : _.selectedCurrency}",
                                                  maxLines: 1,
                                                  overflow:
                                                      TextOverflow.ellipsis,
                                                  style: context.t.displayMedium
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              ...
                                              alignment: Alignment.centerRight,
                                              child: Text(
                                                  "${Helpers.numberFormatWithAsFixed2("", productManageCtrl.payableAmount)} ${_.is_crypto ? "USD" : _.selectedCurrency}",
                                                  maxLines: 1,
                                                  overflow:
                                                      TextOverflow.ellipsis,
                                                  style: context.t.displayMedium
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              ...
                                              alignment: Alignment.centerRight,
                                              child: Text(
                                                  "${productManageCtrl.payableInBaseCurr}  ${HiveHelp.read(Keys.baseCurrency)}",
                                                  maxLines: 1,
                                                  overflow:
                                                      TextOverflow.ellipsis,
                                                  style: context.t.displayMedium
                            ...
                            Material(
                              color: Colors.transparent,
                              child: AppButton(
                                isLoading: productManageCtrl.isPayment ||
                                        _.isLoadingPaymentSheet
                                    ? true
                                    : false,
                                onTap: productManageCtrl.isPayment ||
                                        _.isLoadingPaymentSheet
                                    ? null
                                    : () async {
                                        Helpers.hideKeyboard();
